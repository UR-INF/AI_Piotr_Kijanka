			...
			<div class = "panel-body">
				...
				<div style = "height:300px; width:800px;">
					...
					<div style = "float:left; margin-left:10px;">
						...
						<h3 style = "color:#00ff00;"><?php echo "Cena. ".$fetch['price'].".00";?></h3>
					</div>
				</div>
				<br style = "clear:both;" />
				<div class = "well col-md-4">
					<form method = "POST" enctype = "multipart/form-data">
						...
						<br />
						<div class = "form-group">
							<button class = "btn btn-info form-control" name = "add_guest"><i class = "glyphicon glyphicon-save"></i>Zatwierdź</button>
						</div>
					</form>
				</div>
